...
import especializado6 from '../Images/especializado6.jpg';
import especializado8 from '../Images/especializado8.jpg';
import especializado4 from '../Images/especializado4.jpg';
import especializado2 from '../Images/especializado2.jpg';
import especializado5 from '../Images/especializado5.jpg';
import especializado7 from '../Images/especializado7.jpg';
import proyectoespecializado6patrimonio from '../Images/proyectoespecializado6patrimonio.jpg';
import especializado1 from '../Images/especializado1.jpg';
import proyectoespecializado5 from '../Images/proyectoespecializado5.jpg';
...
const Proyects2 = () => {
  return (
    ...
    height: '85%',
      ...
      <img src={proyectoespecializado6patrimonio} alt="Avatar"
      style={{ 
        padding: '0%',
        width: '100%',
        height: '75%',
        ...
        <div  style={{
            ...
            backgroundColor: '#FA0429',
               ...
               style={{
                ...
                }}>Participamos en un sin numero de proyectos, ofrecemos todo tipo de soluciones empresa.  </p>
    ...
    <div style={{width:'35%', height:'34%', paddingLeft:'0%'}}>
      <img src={especializado6} alt="Avatar"
      style={{ 
        padding: '0%',
        width: '100%',
        height: '100%',
    ...
    <div style={{width:'60%', height:'53%', paddingLeft:'0%'}}
    >
      <img src={especializado4} alt="Avatar"
       style={{ 
        padding: '0%',
        width: '100%',
        height: '100%',
    ...
    <div style={{width:'100%', height:'50%', paddingLeft:'0%'}}>
      <img src={especializado8} alt="Avatar"
       style={{ 
        paddingRight:'0%',
        width: '100%',
        height: '100%',
    ...
    <div style={{width:'100%', height:'50%', paddingLeft:'0%'}}>
      <img src={especializado2} alt="Avatar"
      style={{ 
        padding: '0%',
        width: '100%',
        height: '100%',
    ...
    <div style={{width:'45%', height:'40%', paddingLeft:'0%'}}
    >
      <img src={proyectoespecializado5} alt="Avatar"
       style={{ 
        padding: '0%',
        width: '100%',
        height: '100%',
    ...
    <div style={{width:'53%', height:'32%', paddingLeft:'0%'}}>
      <img src={especializado1} alt="Avatar"
       style={{ 
        paddingRight:'0%',
        width: '100%',
        height: '100%',
    ...
    <div style={{width:'33%', height:'33%',paddingLeft:'0.5%'}}>
      ...
      <div style={{width:'30%', height:'30%', paddingLeft:'0%'}}>
      <img src={especializado5} alt="Avatar"
       style={{ 
        padding: '0%',
        width: '100%',
        height: '100%',
      ...
      <img src={especializado7} alt="Avatar"
       style={{ 
        padding: '0%',
        width: '100%',
        height: '100%',
